...
- Ready-to-use "solde de tout compte" template (French deposit-refund settlement letter) in `documentation/templates/solde-de-tout-compte.md`, to copy into the landlord text-template editor.
